...
Quick Start and User Manual are in "documentation." folder.
Please read them to avoid confusion.

The optional prebuilt Discord rich presence companion is in the
"Discord Rich Presence" folder. Run the EXE on the host machine while FLAP is
